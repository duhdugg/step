...
;
wasmImports.jsbody = {
	'_Bridge.export___Function_BiConsumer_Function_V' : (...args) => (function(getPassageFn,seedFn,initEngineFn){
		try{
			globalThis.getPassageText = getPassageFn;globalThis.seedFile = seedFn;globalThis.initEngine = initEngineFn;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_Bridge.log___JSString_V' : (...args) => (function(msg){
		try{
			console.log('JAVA:', msg);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_Bridge.parseJson___JSString_Object' : (...args) => (function(json){
		try{
