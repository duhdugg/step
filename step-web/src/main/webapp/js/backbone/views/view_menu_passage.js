var PassageMenuView = Backbone.View.extend({
    ...
    readerMode: '<li><a href="javascript:void(0)" data-selected="true"><span>Reader Mode</span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isReaderMode ? "visible" : "hidden" %>"></span></a></li>',  // FIXME: Translate
