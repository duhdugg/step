...
public class BibleInformationServiceImpl implements BibleInformationService {
    ...
    public OsisWrapper getPassageText(final String version, final int startVerseId, final int endVerseId,
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 1");
    ...
    public OsisWrapper getPassageText(final String version, final String reference, final String options,
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - ALPHA");

        final List<String> extraVersions = getExtraVersionsFromString(interlinearVersion);
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - BRAVO");
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - getDisplayMode");
        System.err.println("!!! DEBUG CHECK: is metadata service null? " + (this.jswordMetadata == null));
        System.err.flush();
        System.out.println(interlinearMode);
        System.out.println(version);
        System.out.println(extraVersions);
        System.out.println(this.optionsValidationService);
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - CHARLIE");

        OsisWrapper passageText;
        final List<TrimmedLookupOption> removedOptions = new ArrayList<>(4);
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - DELTA");
        final List<LookupOption> inputLookupOptions = this.optionsValidationService.getLookupOptions(options);
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - ECHO");
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - FOXTROT");
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - GOLF");

        if (INTERLINEAR != desiredModeOfDisplay && NONE != desiredModeOfDisplay) {
            // split the versions
            System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - HOTEL");
            ...
            System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - INDIA");
            try {
                ...
                System.err.println("CRASH IN INDIA BLOCK:");
                e.printStackTrace();
                throw e; // Still throw it so you know it failed
            }
        }
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - JULIETT");
        passageText.setRemovedOptions(removedOptions);
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - KILO");
        passageText.setPreviousChapter(this.jswordPassage.getSiblingChapter(passageText.getOsisId(), version, true));
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - LIMA");
        passageText.setNextChapter(this.jswordPassage.getSiblingChapter(passageText.getOsisId(), version, false));
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - MIKE");
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - NOVEMBER");
        ...
        System.out.println("CustomBibleInformationServiceImpl.getPassageText - impl 2 - OSCAR");
        return passageText;
    }
