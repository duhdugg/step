...
public class RawLDBackendState extends AbstractOpenFileState  {
     ...
     */
     RawLDBackendState(SwordBookMetaData bookMetaData) throws BookException {
        ...
        try {
            ...
            // Open the files
            idxRaf = new WasmRandomAccessFile(idxFile, FileUtil.MODE_READ);
            datRaf = new WasmRandomAccessFile(datFile, FileUtil.MODE_READ);
     ...
     * @return the idxRaf
     */
    public WasmRandomAccessFile getIdxRaf() {
        return idxRaf;
    }
     ...
     * @return the datRaf
     */
    public WasmRandomAccessFile getDatRaf() {
        return datRaf;
    }
     ...
     */
    private WasmRandomAccessFile idxRaf;
     ...
     */
    private WasmRandomAccessFile datRaf;
