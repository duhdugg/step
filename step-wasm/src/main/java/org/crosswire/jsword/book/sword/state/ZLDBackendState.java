...
public class ZLDBackendState extends RawLDBackendState {
     ...
     */
     ZLDBackendState(SwordBookMetaData bookMetaData) throws BookException {
        ...
        try {
            ...
            // Open the files
            zdxRaf = new WasmRandomAccessFile(zdxFile, FileUtil.MODE_READ);
            zdtRaf = new WasmRandomAccessFile(zdtFile, FileUtil.MODE_READ);
     ...
     * @return the zdxRaf
     */
    public WasmRandomAccessFile getZdxRaf() {
        return zdxRaf;
    }
     ...
     * @return the zdtRaf
     */
    public WasmRandomAccessFile getZdtRaf() {
        return zdtRaf;
    }
     ...
     */
    private WasmRandomAccessFile zdxRaf;
     ...
     */
    private  WasmRandomAccessFile zdtRaf;
